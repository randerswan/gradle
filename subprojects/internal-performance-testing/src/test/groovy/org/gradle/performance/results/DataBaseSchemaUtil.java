...
class DataBaseSchemaUtil {
    ...
    static void removeOutdatedColumnsFromTestExecutionTable(Connection connection, Statement statement) throws SQLException {
        for (String removedColumn : REMOVED_COLUMNS) {
            if (columnExists(connection, "TESTEXECUTION", removedColumn)) {
